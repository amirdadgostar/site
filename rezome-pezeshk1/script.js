 ...
 * VERSION: 3.6 (FINAL ULTIMATE EDIT - RESUME OVERHAUL & FAB TWEAK)
 * DESCRIPTION: Definitive Logic.
 *              - FAB Button logic preserved (10s delay).
 *              - vCard Toast message updated strictly.
 *              - PDF Generation logic optimized for new graphical layout.
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // =======================================================
    // 9. تولید PDF حرفه‌ای (Resume Generation)
    // =======================================================
    window.generateFullPDF = function() {
        ...
        const options = {
            margin: 0,
            filename: 'Dr-Sara-Radmanesh-Resume-Official.pdf',
    ...
    window.downloadVCard = function() {
        ...
        // [ویرایش درخواستی] تغییر متن پیام به دستور شما
